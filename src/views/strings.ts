...
export const t = {
  ...
  sessionSync: {
    ...
    badge: "Sync",
    statusLabel: "Synced",
    hint: "Share logins and chats with other profiles",
  ...
  detail: {
    ...
    editConfigHint: "Edit this profile's MCP servers",
    assignToGroupHint: "Move this profile into a group",
    reveal: nouns.revealButton,
    revealHint: "Open the profile's folder",
